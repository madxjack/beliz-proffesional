    ...
    <header className={`fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top ? 'bg-white backdrop-blur-sm shadow-lg' : ''}`}>
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between w-full h-16 md:h-20">
          ...
          {/* Site branding */}
          <div className="shrink-0 mr-4 md:flex-1 flex-grow-0">
            <Logo />
          </div>

          <div className="font-bold md:text-xl flex-1 md:flex-0 text-center">
            BELIZ BEAUTY
          </div>

          {/* Desktop navigation */}
          <nav className="hidden md:flex md:grow flex-1 justify-end">
